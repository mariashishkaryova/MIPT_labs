...
f_n = [3.95, 7.91, 11.86, 15.80, 19.76]
n = [1, 2, 3, 4, 5]
...
f = np.poly1d(t)
k = (f_n[4] - f_n[0])/(n[4] - n[0])
sigma_k = k * ((0.05/f_n[4])**2 + (0.05/f_n[0])**2)**0.5
print('k = ', k, 'МГц')
...
plt.title('f(n) для прямоугольного импульса(согласованная линия)')
plt.grid(linewidth = 0.3)
plt.legend()
plt.savefig('прямоугольный импульс(согласованная линия).png')
plt.show()