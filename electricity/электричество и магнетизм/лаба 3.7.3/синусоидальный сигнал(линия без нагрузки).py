...
f_n = [3.97, 7.94, 11.90, 15.88, 19.70, 23.64]
n = [1, 2, 3, 4, 5, 6]
...
plt.title('f(n) для синусоидального сигнала(линия без нагрузки)')
plt.grid(linewidth = 0.3)
plt.legend()
plt.savefig('синусоидальный сигнал(линия без нагрузки).png')
plt.show()