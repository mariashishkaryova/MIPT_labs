...
ax.errorbar(n_1, T_1, yerr=yer1, fmt='.', linewidth=2, capsize=5)
plt.xlabel('n')
plt.ylabel('T, c')
plt.grid()
plt.savefig('график зависимости T(n).png')
plt.show()
...
ax.errorbar(n_2, M, yerr=yer2, fmt='.', linewidth=2, capsize=5)
plt.xlabel('n')
plt.ylabel('M, дин*cм')
plt.grid()
plt.savefig('график зависимости M(n).png')
plt.show()
